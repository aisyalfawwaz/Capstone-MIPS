...
class UploadForm(FlaskForm):
	"""Upload image form"""
	photo = FileField('Unggah gambar sel di bawah ini', validators=[FileAllowed(['jpg', 'png', 'jpeg'], 
	u'Image only!'), FileRequired(u'Gambar Kosong!')])
	submit = SubmitField(u'Prediksi!')
